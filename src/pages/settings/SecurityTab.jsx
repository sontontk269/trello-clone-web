  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      ...
      .then(() => {
        ...
        // Gọi API...
        toast.promise(dispatch(updateUserAPI({ current_password, new_password })), { pending: 'Updating...' }).then((res) => {
          if (!res.error) toast.success('Changed password successfully! Please login again.')
