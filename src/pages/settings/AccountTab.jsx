...
function AccountTab() {
  ...
  const uploadAvatar = (e) => {
    ...
    toast.promise(dispatch(updateUserAPI(reqData)), { pending: 'Uploading...' }).then((res) => {
      if (!res.error) toast.success('Uploaded avatar successfully!')
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <Box>
            <Avatar sx={{ width: 84, height: 84, mb: 1 }} alt="" src={currentUser?.avatar} />
