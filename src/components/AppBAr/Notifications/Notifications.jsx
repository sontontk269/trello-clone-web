...
function Notifications() {
  ...
  useEffect(() => {
    ...
    socketIoInstance.on('BE_INVITE_USER_TO_BOARD', onNewInvitation)

    //clean up event
    return () => {
      socketIoInstance.off('BE_INVITE_USER_TO_BOARD', onNewInvitation)
    }
  }, [dispatch, currentUser._id])

  const updateBoardInvitation = (status, invitationId) => {
    dispatch(updateBoardInvitationsAPI({ status, invitationId })).then((res) => {
